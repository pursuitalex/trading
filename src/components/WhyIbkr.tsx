      ...
      <div className="container">
        <Reveal className="calc__head" variant="fadeBlur">
          ...
          <p className="calc__subtitle">
            Ми не приймаємо ваші кошти на свої рахунки. Ви відкриваєте власний акаунт у найбільшого
        ...
        <div className="ibkr__grid">
          ...
          >
            ...
            <p className="ibkr__note">
              Ви відкриваєте власний акаунт у найбільшого американського брокера, а наш алгоритм
